...
@Constraint(validatedBy = UniquePhone.Validator.class)
@Target({ ElementType.TYPE })
@Retention(RetentionPolicy.RUNTIME)
public @interface UniquePhone {
    String message() default "Bu telefon numarası ile ilişkili bir hesap zaten var!";

    Class<?>[] groups() default {};

    Class<? extends Payload>[] payload() default {};

    class Validator implements ConstraintValidator<UniquePhone, User> {
        @PersistenceContext
        ...
        public boolean isValid(User user, ConstraintValidatorContext constraintValidatorContext) {
            ...
            var existUser = userRepository.findByPhone(phone);
