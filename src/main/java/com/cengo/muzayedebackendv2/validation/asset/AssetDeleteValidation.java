...
public class AssetDeleteValidation implements Validation<AssetDeleteValidation.Context> {
    ...
    public void validate(Context context) {
        initialize()
                ...
                .linkWith(new AssetDomainTypeValidation())
                .validate(context);
    }
    ...
    private static class AssetDomainTypeValidation extends ValidationStep<Context> {
        @Override
        public void validate(Context context) {
            checkCondition(context.asset.getDomainType().isDeletable(), ErrorMessage.ASSET_NOT_DELETED);
            checkNext(context);
        }
    }
