package com.cengo.muzayedebackendv2.security;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.cengo.muzayedebackendv2.config.properties.JwtProperties;
...
public class JwtService {
    ...
    public String issue(UserPrincipal user) {
        var role = user.getAuthorities().stream()
                .map(Object::toString)
                .toList();
        var expires = Instant.now().plus(Duration.of(10, ChronoUnit.MINUTES));
